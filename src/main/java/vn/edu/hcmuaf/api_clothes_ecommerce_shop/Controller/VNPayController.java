...
import vn.edu.hcmuaf.api_clothes_ecommerce_shop.Config.VNPayConfig;
import vn.edu.hcmuaf.api_clothes_ecommerce_shop.Dto.PaymentReqDTO;
import vn.edu.hcmuaf.api_clothes_ecommerce_shop.Dto.PaymentResDTO;
...
public class VNPayController {
    ...
    @Autowired
    private VNPayController(HttpServletRequest request) {
